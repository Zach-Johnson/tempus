...
curl -X POST \
  ...
  -d '{
    "name": "Rudiments",
    "description": "Standard drum rudiments and techniques"
  }' | jq
...
curl -X GET http://localhost:8080/v1/exercises/1 | jq

# List all exercises
curl -X GET http://localhost:8080/v1/exercises | jq

# List with pagination
curl -X GET "http://localhost:8080/v1/exercises?page_size=5" | jq

# Filter by category
curl -X GET "http://localhost:8080/v1/exercises?category_id=1" | jq

# Filter by tag
curl -X GET "http://localhost:8080/v1/exercises?tag_id=1"  | jq

# Filter by both category and tag
curl -X GET "http://localhost:8080/v1/exercises?category_id=1&tag_id=1" | jq

# Update the name and description
curl -X PATCH \
  http://localhost:8080/v1/exercises/1 \
  -H 'Content-Type: application/json' \
  -d '{
    "exercise": {
...
curl -X POST \
  http://localhost:8080/v1/exercises/1/images \
  -H 'Content-Type: application/json' \
  -d '{
    "exercise_id": 1,
...
# curl -X DELETE http://localhost:8080/v1/exercise-images/1 | jq

curl -X POST \
  http://localhost:8080/v1/exercises/1/links \
  -H 'Content-Type: application/json' \
  -d '{
    "exercise_id": 1,
...
# curl -X DELETE http://localhost:8080/v1/exercise-links/1 | jq

curl -X GET "http://localhost:8080/v1/exercises/1/stats" | jq

# curl -X DELETE http://localhost:8080/v1/exercises/1 | jq
...
# Assuming session ID is 1
curl -X GET http://localhost:8080/v1/sessions/1 | jq

# List all sessions
curl -X GET http://localhost:8080/v1/sessions | jq

# With pagination
curl -X GET "http://localhost:8080/v1/sessions?page_size=5" | jq

# Filter by date range
curl -X GET "http://localhost:8080/v1/sessions?start_date=2025-04-01T00:00:00Z&end_date=2025-04-30T23:59:59Z" | jq

# Filter by exercise ID
curl -X GET "http://localhost:8080/v1/sessions?exercise_id=1" | jq

# Update session notes
curl -X PATCH \
  http://localhost:8080/v1/sessions/1 \
  -H 'Content-Type: application/json' \
  -d '{
    "session": {
...
curl -X GET http://localhost:8080/v1/history | jq

# Filter by exercise
curl -X GET "http://localhost:8080/v1/history?exercise_id=1" | jq

# Filter by session (assuming you've added this query parameter)
curl -X GET "http://localhost:8080/v1/history?session_id=1" | jq

# Filter by date range
curl -X GET "http://localhost:8080/v1/history?start_date=2025-04-01T00:00:00Z&end_date=2025-04-30T23:59:59Z" | jq
